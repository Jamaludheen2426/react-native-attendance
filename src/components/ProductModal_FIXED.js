...
const ProductModal = ({
  ...
  useEffect(() => {
    const loadProductData = async () => {
      if (product) {
        ...
        const hasVariantsValue = product.has_variants === 1 || product.hasVariants === true;
  ...
  const handleSave = () => {
    ...
    if (hasVariants && variants.length === 0) {
      showAlert('Missing Variants', 'Please add at least one variant or disable variants');
      return;
    }
          ...
          >
            ...
            <View style={styles.inputGroup}>
              ...
              >
                ...
                <Icon name={showCategoryPicker ? "chevron-up" : "chevron-down"} size={20} color="#666" />
              </TouchableOpacity>
              {showCategoryPicker && (
            ...
            <View style={styles.variantsSection}>
              <View style={styles.variantsHeader}>
                ...
                >
                  <View style={[styles.switchTrack, hasVariants && styles.switchTrackActive]}>
                    <View style={[styles.switchThumb, hasVariants && styles.switchThumbActive]} />
                  </View>
                </TouchableOpacity>
              </View>
                      ...
                      {showAddVariant ? (
                        <View style={styles.addVariantForm}>
                          ...
                          <View style={styles.variantFormButtons}>
                            ...
                            >
                              <Text style={styles.variantCancelText}>Cancel</Text>
                            </TouchableOpacity>
                            <TouchableOpacity
